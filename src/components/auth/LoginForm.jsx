			...
			<div className="flex flex-col items-center w-full">
				...
				<div className="w-full text-center mb-8">
					<AnimatedText
						...
						className="mb-3"
					/>
					<p className="text-sm font-medium text-gray-600">Bienvenido de vuelta</p>
				</div>
				...
				/>
					...
					<div>
						...
						<div className="relative">
							<LockIcon className="absolute left-3.5 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 pointer-events-none z-10" />
							<Input
								id="password"
								type="password"
								placeholder="******"
