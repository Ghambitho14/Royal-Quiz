  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="text-center mb-8 animate-[fadeIn_0.8s_ease-out] relative">
        ...
        <div className="bg-linear-to-r from-amber-400/20 via-yellow-400/20 to-amber-400/20 backdrop-blur-2xl border-2 border-amber-400/60 rounded-3xl px-8 py-5 inline-block shadow-2xl shadow-amber-500/30 animate-[slideUp_0.8s_ease-out]">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        <Card className="p-4 bg-linear-to-br from-blue-50 to-blue-100/50 backdrop-blur-xl border-2 border-blue-300 rounded-2xl text-center shadow-lg">
        ...
        <Card className="p-4 bg-linear-to-br from-purple-50 to-purple-100/50 backdrop-blur-xl border-2 border-purple-300 rounded-2xl text-center shadow-lg">
        ...
        <Card className="p-4 bg-linear-to-br from-amber-50 to-amber-100/50 backdrop-blur-xl border-2 border-amber-300 rounded-2xl text-center shadow-lg">
      ...
      <Card className="p-8 bg-white/98 backdrop-blur-2xl shadow-2xl border-0 rounded-3xl overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-2 bg-linear-to-r from-amber-500 via-yellow-500 to-amber-600"></div>
        
        {/* Header */}
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="p-3 bg-linear-to-br from-amber-500 to-yellow-600 rounded-2xl shadow-xl animate-pulse">
            <Trophy className="size-8 text-white" />
          </div>
          <h3 className="text-4xl font-bold tracking-tight bg-linear-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">
            Tabla de Posiciones
          </h3>
        </div>
            ...
            return (
              <div 
                ...
                className={`flex items-center gap-5 p-6 rounded-2xl transition-all mb-4 relative overflow-hidden ${
                  index === 0 
                    ? 'bg-linear-to-r from-amber-50 via-yellow-50 to-amber-50 border-2 border-amber-400 shadow-2xl shadow-amber-500/30 scale-[1.03]' 
                    : index === 1
                    ? 'bg-linear-to-r from-gray-50 via-slate-50 to-gray-50 border-2 border-gray-400 shadow-xl'
                    : 'bg-linear-to-r from-orange-50 via-amber-50 to-orange-50 border-2 border-orange-400 shadow-xl'
                }`}
              >
                ...
                <div className="flex-1 relative z-10">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {index === 0 && (
                      <Badge className="bg-linear-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white shadow-md border-0 text-sm">
                        👑 Campeón
                      </Badge>
                    )}
                    {index === 1 && (
                      <Badge className="bg-linear-to-r from-gray-400 to-gray-500 text-white shadow-md border-0 text-sm">
                        🥈 2º Lugar
                      </Badge>
                    )}
                    {index === 2 && (
                      <Badge className="bg-linear-to-r from-orange-500 to-orange-600 text-white shadow-md border-0 text-sm">
                        🥉 3º Lugar
                      </Badge>
                    )}
                  </div>
        ...
        {sortedPlayers.length > 3 && (
          <>
            <Separator className="my-6 bg-linear-to-r from-transparent via-gray-300 to-transparent h-0.5" />
            ...
            <div className="space-y-3">
              {sortedPlayers.slice(3).map((player, index) => {
                ...
                return (
                  <div 
                    key={player.id}
                    className="flex items-center gap-4 p-5 bg-linear-to-r from-gray-50 via-white to-gray-50 rounded-2xl border-2 border-gray-200 hover:shadow-lg hover:border-blue-300 transition-all group relative overflow-hidden"
                  >
                    {/* Progress bar background */}
                    <div 
        ...
        <div className="mt-8 space-y-4">
          <Button 
            onClick={onPlayAgain}
            className="w-full bg-linear-to-r from-blue-700 via-blue-800 to-blue-900 hover:from-blue-800 hover:via-blue-900 hover:to-blue-950 text-xl h-18 rounded-2xl shadow-2xl shadow-blue-700/50 hover:shadow-3xl hover:shadow-blue-700/60 transition-all hover:scale-[1.02] font-bold py-6"
          >
